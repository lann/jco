                ...
                output.push_str(&format!(r#"
                    class {task_class} {{
                        ...
                        enterSync() {{
                            if (this.needsExclusiveLock()) {{
                                ...
                                if (!cstate.isExclusivelyLocked()) {{
                                    ...
                                    // release still pairs (see lann/jco#30).
                        ...
                        exit(args) {{
                            ...
                            // longer clears the foreign hold; see lann/jco#30).
                    ...
                    async function {driver_loop_fn}(args) {{
                        ...
                        try {{
                            while (true) {{
                                ...
                                // suspensions; see lann/jco#30, lann/jco#48).
            ...
            Self::EnterSymmetricSyncGuestCall => {
                ...
                output.push_str(&format!(
                    ...
                    function {enter_symmetric_sync_guest_call_fn}(callerComponentIdx, calleeIsAsync, calleeComponentIdx) {{
                        ...
                        // stealing the hold (see lann/jco#30, lann/jco#48); the returned
